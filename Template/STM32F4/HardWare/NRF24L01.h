...
//GPIO
#define NRF24L01_GPIO_CLK                   RCC_AHB1Periph_GPIOC
#define NRF24L01_GPIO_APBxClockCMD          RCC_AHB1PeriphClockCmd

#define NRF24L01_GPIO_PORT                  GPIOC
#define NRF24L01_CE_GPIO_PIN                GPIO_Pin_8
#define NRF24L01_CS_GPIO_PIN                GPIO_Pin_9
#define NRF24L01_IRQ_GPIO_PIN               GPIO_Pin_7

#define NRF24L01_CE_HIGH()                  GPIO_SetBits(NRF24L01_GPIO_PORT,NRF24L01_CE_GPIO_PIN)
#define NRF24L01_CE_LOW()                	GPIO_ResetBits(NRF24L01_GPIO_PORT,NRF24L01_CE_GPIO_PIN)
#define NRF24L01_CS_HIGH()                  GPIO_SetBits(NRF24L01_GPIO_PORT,NRF24L01_CS_GPIO_PIN)
#define NRF24L01_CS_LOW()                	GPIO_ResetBits(NRF24L01_GPIO_PORT,NRF24L01_CS_GPIO_PIN)
#define NRF24L01_IRQ_Read()                	GPIO_ReadInputDataBit(NRF24L01_GPIO_PORT,NRF24L01_IRQ_GPIO_PIN)
